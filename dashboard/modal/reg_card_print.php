...
<?php
include("config.php");
$sql = mysqli_query("select valid_days from validity_days");
if($sql){
...
<tr><td colspan='3'><hr></td></tr>
    ...
    <tr><td><b>1</b></td><td><b><?php echo $opt_type; ?> Consultation</b></td><td><b><?php echo $amount?></b></td></tr>
	
	<tr><td colspan='3'><hr></td></tr>
	
	<tr><td></td><td></td>
	
	<td colspan="0"  ><span style="margin-left:-70px">Total Amount:</span>  <?php echo $amount?></td></tr>
