					                            ...
					                            <div class="card card-topline-red">
					                                ...
					                                <div class="card-body ">
					                                    ...
					                                    <div class="table-scrollable">
															...
															$sq=mysqli_query($link,"select distinct a.lr_no,a.cust_name,a.inv_no,a.total,a.sal_date,
															a.customer_type,a.final_amnt
				 from phr_salent_mast as a,phr_salent_dtl as b where a.lr_no=b.lr_no and a.customer_type!='h' order by a.LR_NO desc");
															$i=1;
